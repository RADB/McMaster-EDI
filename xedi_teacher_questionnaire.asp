...
'		conn.execute "UPDATE children SET chkCompleted = true, dtmDate = '" & date & "' WHERE strEDIID = '" & strEDIID & "'"	
	...
	' start child section
	if strChild <> "" then
        strFrench = "&nbsp;<font class=""regtextblack"">></font>&nbsp;<a class=""reglinkMaroon"" href=""javascript:goChild('" & strEDIYear & "','" & strSite & "','" & strSchool & "','','','');"">" & lblTeacher &"</a>&nbsp;<font class=""regtextblack"">></font>&nbsp;<a class=""reglinkMaroon"" href=""javascript:goChild('" & strEDIYear & "','" & strSite & "','" & strSchool & "','" & strTeacher  & "','','');"">Classe</a>&nbsp;<font class=""regtextblack"">></font>&nbsp;<a class=""reglinkMaroon"" href=""javascript:goChild('" & strEDIYear & "','" & strSite & "','" & strSchool & "','" & strTeacher  & "','" & strClass  & "','');"">l�ve</a>&nbsp;<font class=""regtextblack"">></font>&nbsp;<font class=""boldtextblack"">IMDPE Questionnaire</font>"
	...
	' no child in the form data
		...
		if strClass <> "" then 
			...
			strFrench = "&nbsp;<font class=""regtextblack"">></font>&nbsp;<a class=""reglinkMaroon"" href=""javascript:goChild('" & strEDIYear & "','" & strSite & "','" & strSchool & "','','','');"">"&lblTeacher&"</a>&nbsp;<font class=""regtextblack"">></font>&nbsp;<a class=""reglinkMaroon"" href=""javascript:goChild('" & strEDIYear & "','" & strSite & "','" & strSchool & "','" & strTeacher  & "','','');"">Classe</a>&nbsp;<font class=""regtextblack"">></font>&nbsp;<font class=""boldtextblack"">�l�ve</font>"
			...
			<tr>
				<td>
					<table border="0" cellpadding="0" cellspacing="0" width="750" align="center">
						...
						<tr><td colspan="2"><%="<br/>" & str rror%></td></tr>
					</table>
