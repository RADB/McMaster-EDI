								...
								do while not rstData.EOF 
									...
									if session("province") = 3 then 										
										...
										if rstData("intConsent") =1 then 
											response.write "checked disabled data-toggle=""toggle"" data-off=""" & lblConsentNo & """ data-on=""" & lblConsentYes & """ data-onstyle=""success"" data-offstyle=""danger"" data-size=""mini""></td>"
