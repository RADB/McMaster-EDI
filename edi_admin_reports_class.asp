...
<body>
	...
	' start child section
	'if strChild <> "" then 
	'	strMap = "&nbsp;<font class=""regtextblack"">></font>&nbsp;<a class=""reglinkMaroon"" href=""edi_admin_reports_class.asp"">Site Selection</a>&nbsp;<font class=""regtextblack"">></font>&nbsp;<a class=""reglinkMaroon"" href=""javascript:goChild('" & strSite & "','','','','');"">School Selection</a>&nbsp;<font class=""regtextblack"">></font>&nbsp;<a class=""reglinkMaroon"" href=""javascript:goChild('" & strSite & "','" & strSchool & "','','','');"">Teacher Selection</a>&nbsp;<font class=""regtextblack"">></font>&nbsp;<a class=""reglinkMaroon"" href=""javascript:goChild('" & strSite & "','" & strSchool & "','" & strTeacher  & "','','');"">Class Selection</a>&nbsp;<font class=""regtextblack"">></font>&nbsp;<a class=""reglinkMaroon"" href=""javascript:goChild('" & strSite & "','" & strSchool & "','" & strTeacher  & "','" & strClass  & "','');"">Child Selection</a>&nbsp;<font class=""regtextblack"">></font>&nbsp;<font class=""boldtextblack"">Child Questionnaire</font>"
	...
	'else
		' start class section
		'if strClass <> "" then 
		'	strMap = "&nbsp;<font class=""regtextblack"">></font>&nbsp;<a class=""reglinkMaroon"" href=""edi_admin_reports_class.asp"">Site Selection</a>&nbsp;<font class=""regtextblack"">></font>&nbsp;<a class=""reglinkMaroon"" href=""javascript:goChild('" & strSite & "','','','','');"">School Selection</a>&nbsp;<font class=""regtextblack"">></font>&nbsp;<a class=""reglinkMaroon"" href=""javascript:goChild('" & strSite & "','" & strSchool & "','','','');"">Teacher Selection</a>&nbsp;<font class=""regtextblack"">></font>&nbsp;<a class=""reglinkMaroon"" href=""javascript:goChild('" & strSite & "','" & strSchool & "','" & strTeacher  & "','','');"">Class Selection</a>&nbsp;<font class=""regtextblack"">></font>&nbsp;<font class=""boldtextblack"">Child Selection</font>"
		...
		'else
			...
			if strTeacher <> "" then 
				strMap = "&nbsp;<font class=""regtextblack"">></font>&nbsp;<a class=""reglinkMaroon"" href=""edi_admin_reports_class.asp"">Site Selection</a>&nbsp;<font class=""regtextblack"">></font>&nbsp;<a class=""reglinkMaroon"" href=""javascript:goChild('" & strSite & "','','','','');"">School Selection</a>&nbsp;<font class=""regtextblack"">></font>&nbsp;<a class=""reglinkMaroon"" href=""javascript:goChild('" & strSite & "','" & strSchool & "','','','');"">Teacher Selection</a>&nbsp;<font class=""regtextblack"">></font>&nbsp;<font class=""boldtextblack"">Class Selection for Class Summary Report</font>"
			...
			' no teacher in the form data
				...
				if strSchool <> "" then 
					strMap = "&nbsp;<font class=""regtextblack"">></font>&nbsp;<a class=""reglinkMaroon"" href=""edi_admin_reports_class.asp"">Site Selection</a>&nbsp;<font class=""regtextblack"">></font>&nbsp;<a class=""reglinkMaroon"" href=""javascript:goChild('" & strSite & "','','','','');"">School Selection</a>&nbsp;<font class=""regtextblack"">></font>&nbsp;<font class=""boldtextblack"">Teacher Selection for Class Summary Report</font>"
				...
				' no school in the form data
					...
					' start site section
					if strSite <> "" then 
						strMap = "&nbsp;<font class=""regtextblack"">></font>&nbsp;<a class=""reglinkMaroon"" href=""edi_admin_reports_class.asp"">Site Selection</a>&nbsp;<font class=""regtextblack"">></font>&nbsp;<font class=""boldtextblack"">School Selection for Class Summary Report</font>"
					...
					' no site in the form data
						...
						strMap = "&nbsp;<font class=""regtextblack"">></font>&nbsp;<font class=""boldtextblack"">Site Selection for Class Summary Report</font>"
	...
	'end if
	%>
	<form name="Children" method="POST" action="edi_admin_reports_class.asp"> 
			...
			<tr>
				<td>
					<table border="0" cellpadding="0" cellspacing="0" width="760">
						<tr>
							<td align="right" width="480">
								<font class="headerBlue">Class Summary(<%=strEDIID%>)</font>
							</td>
							<td align="right">
					...
					<table border="0" cellpadding="0" cellspacing="0" width="750" align="center">						
						...
						'				Response.Write "<a class=""reglinkMaroon"" href=""javascript:goChild('" & left(strEDIID,3) & "','" & mid(strEDIID,4,3) & "','" & mid(strEDIID,7,2) & "','" & mid(strEDIID,9,1) & "','" & right("00" & aChildren(1,intRow),2) & "');"">" & day(aChildren(5,intRow)) & "-" & monthname(datepart("m",aChildren(5,intRow)),true) & "-" & year(aChildren(5,intRow)) & "</a>"
						'				Response.Write "<br/>"
						'			next
						'		end if 
						'		Response.Write "</td></tr></table>"	
							case 527 ' class
								...
								Response.Write "<table border=""0"" cellpadding=""0"" cellspacing=""0"" width=""500"" align=""center"">"						
								Response.Write "<tr><td><img src=""images/greenbb.gif"">&nbsp;<a class=""reglinkMaroon"" href=""javascript:goReport('" & strEDIID & "');"">All classes for teacher " & strEdIID & "</a>&nbsp;<img src=""images/greenbb.gif""><br /><br /></td><tr>"
								Response.Write "<tr><td>"	
								if strError = "" then 
									for intRow = 0 to ubound(aClasses,2)
										Response.Write "<font class=""regTextBlack"">" & right("0" & aClasses(0,intRow),1) & ") </font>"
										Response.Write "<a class=""reglinkMaroon"" href=""javascript:goReport('" & strEDIID & right(aClasses(0,intRow),1) & "');"">"  & aClass(1,right(aClasses(0,intRow),1)) & "</a>"
							...
							case 387	' teacher
								Response.Write "<table border=""0"" cellpadding=""0"" cellspacing=""0"" width=""500"" align=""center"">"						
								Response.Write "<tr><td><img src=""images/greenbb.gif"">&nbsp;<a class=""reglinkMaroon"" href=""javascript:goReport('" & strEDIID & "');"">All classes at school " & strEdIID & "</a>&nbsp;<img src=""images/greenbb.gif""><br /><br /></td><tr>"
								Response.Write "<tr><td>"	
								if strError = "" then 
							...
							case 248 ' school
								Response.Write "<table border=""0"" cellpadding=""0"" cellspacing=""0"" width=""500"" align=""center"">"						
								Response.Write "<tr><td><img src=""images/greenbb.gif"">&nbsp;<a class=""reglinkMaroon"" href=""javascript:goReport('" & strEDIID & "');"">All classes at site " & strEdIID & "</a>&nbsp;<img src=""images/greenbb.gif""><br /><br /></td><tr>"
								Response.Write "<tr><td>"	
								if strError = "" then 
							...
							case 121	' site
								Response.Write "<table border=""0"" cellpadding=""0"" cellspacing=""0"" width=""500"" align=""center"">"						
								Response.Write "<tr><td><img src=""images/greenbb.gif"">&nbsp;<a class=""reglinkMaroon"" href=""javascript:goReport('0');"">All Classes</a>&nbsp;<img src=""images/greenbb.gif""><br /><br /></td><tr>"
								Response.Write "<tr><td>"	
								if strError = "" then 
